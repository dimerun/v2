...
To deploy DimeRun v2, execute the following command with your configuration file:
...
For any questions or assistance, please reach out to our support team at support@dime.run.
